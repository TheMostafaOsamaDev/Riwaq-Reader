...
export const ar: Messages = {
  ...
  "settings.colors.text": "النص",
  "settings.colors.page": "الصفحة",
  "settings.colors.auto": "تلقائي",
  "settings.colors.custom": "مخصص",
  "settings.colors.lowContrast": "تباين منخفض — قد يصعب قراءة النص",
